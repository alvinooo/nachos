...
public class KThread {
	...
	public static void finish() {
		...
		KThread next = currentThread.waitQueue.nextThread();
		if (next != null) {
			next.ready();
		}
	...
	public static void joinTestCase1() {
		...
		child.fork();
		child.join();
		System.out.println("child finished? " + (child.status == statusFinished));
		Lib.assertTrue((child.status == statusFinished), "Expected child to finish");
	}
	
	public static void joinTestCase2() {
